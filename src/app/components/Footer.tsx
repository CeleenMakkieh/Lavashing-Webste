      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-primary-foreground/70">{settings.footerTagline}</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-primary-foreground/70">
              <li><Link href="/work" className="hover:text-primary-foreground transition-colors">Web Design</Link></li>
              <li><Link href="/work" className="hover:text-primary-foreground transition-colors">Web Development</Link></li>
              <li><Link href="/work" className="hover:text-primary-foreground transition-colors">Branding</Link></li>
              <li><Link href="/work" className="hover:text-primary-foreground transition-colors">Marketing</Link></li>
              <li><Link href="/work" className="hover:text-primary-foreground transition-colors">Strategy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-primary-foreground/70">
              ...
              <li><Link href="/work" className="hover:text-primary-foreground transition-colors">Industries</Link></li>
